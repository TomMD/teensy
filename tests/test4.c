...
int main(int argc, char **argv) {
    ...
    /* write to a multi-item list, insert in middle */
    err |= write_file_to_dev(teensy, "data/small", 17);
        
    /* read and test value inserted into multi-item list */
    err |= compare_dev_to_file(teensy, "data/small", 17);
